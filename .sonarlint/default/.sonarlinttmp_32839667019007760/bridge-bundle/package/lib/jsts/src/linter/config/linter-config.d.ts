 ...
 */
export declare function createLinterConfig(inputRules: RuleConfig[], linterRules: Map<string, Rule.RuleModule>, environments?: string[], globs?: string[]): Linter.Config<Linter.RulesRecord, Linter.RulesRecord>;
