...
function checkFormidable(context, callExpression) {
    ...
    if (options) {
        report(context, !!(0, helpers_1.getObjectExpressionProperty)(options, UPLOAD_DIR), keepExtensionsValue((0, helpers_1.getObjectExpressionProperty)(options, KEEP_EXTENSIONS)?.value), callExpression);
    }
}
function checkMulter(context, callExpression) {
    ...
    const storagePropertyValue = (0, helpers_1.getObjectExpressionProperty)(multerOptions, STORAGE_OPTION)?.value;
