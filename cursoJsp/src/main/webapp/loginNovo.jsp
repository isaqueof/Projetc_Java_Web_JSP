	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="ServletLogin"
					method="post">
					<span class="login100-form-title"> Faça Login </span>



					<div class="wrap-input100">
						<input class="input100" type="text" name="uname"
							placeholder="Login" required="required"> <span
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="<%=request.getContextPath()%>/register.jsp">
							Crie sua conta <i class="fa fa-long-arrow-right m-l-5"
							aria-hidden="true"></i>
						</a>
					</div>
