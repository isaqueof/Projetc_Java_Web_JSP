			...
			<ul class="top-nav lft-nav">
				<li><a href="#!" data-toggle="dropdown" role="button"
					...
					class="dropdown-toggle drop icon-circle drop-image"> <i
						class="ti-files"> </i><span> Files</span>
				</a></li>
				<li class="dropdown"><a href="#!" data-toggle="dropdown"
					role="button" aria-haspopup="true" aria-expanded="false"
					class="dropdown-toggle drop icon-circle drop-image"> <span>Dropdown
				...
				<ul class="top-nav">
						...
						<ul class="dropdown-menu">
							...
							<li class="bell-notification"><a href="javascript:;"
								class="media"> <span class="media-left media-icon"> <img
										class="img-circle"
										src="<%=request.getContextPath()%>/assets/images/avatar-1.png"
										alt="User Image">
								</span>
							...
							<li class="bell-notification"><a href="javascript:;"
								class="media"> <span class="media-left media-icon"> <img
										class="img-circle"
										src="<%=request.getContextPath()%>/assets/images/avatar-2.png"
										alt="User Image">
								</span>
									<div class="media-body">
							...
							<li class="bell-notification"><a href="javascript:;"
								class="media"><span class="media-left media-icon"> <img
										class="img-circle"
										src="<%=request.getContextPath()%>/assets/images/avatar-3.png"
										alt="User Image">
								</span>
									<div class="media-body">
					...
					<li class="dropdown"><a href="#!" data-toggle="dropdown"
						...
						class="dropdown-toggle drop icon-circle drop-image"> <span><img
								class="img-circle "
								src="<%=request.getContextPath()%>/assets/images/avatar-1.png"
								style="width: 40px;" alt="User Image"></span> <span><b><%=session.getAttribute("usuario")%></b>
						...
						<ul class="dropdown-menu settings-menu">
							...
							<li><a href="<%=request.getContextPath() %>/ServletLogin?acao=logout"><i class="icon-logout"></i>
									Logout</a></li>
		...
		<section class="sidebar" id="sidebar-scroll">
			...
			<ul class="sidebar-menu">
				...
				<li class="active treeview"><a class="waves-effect waves-dark"
					href="index.html"> <i class="icon-speedometer"></i><span>
							Menu</span>
				</a></li>
				<li class="nav-level">--- Lista</li>
				<li class="treeview"><a class="waves-effect waves-dark"
					href="#!"><i class="icon-briefcase"></i><span> UI Elements</span><i class="icon-arrow-down"></i></a>
					<ul class="treeview-menu">
						...
						<li><a class="waves-effect waves-dark"
							href="label-badge.html"><i class="icon-arrow-right"></i>
								Label Badge</a></li>
						<li><a class="waves-effect waves-dark"
				...
				<li class="treeview"><a class="waves-effect waves-dark"
					href="#!"><i class="icon-chart"></i><span> Charts &amp;
							Maps</span><span class="label label-success menu-caption">New</span><i
						class="icon-arrow-down"></i></a>
					<ul class="treeview-menu">
						<li><a class="waves-effect waves-dark"
							href="float-chart.html"><i class="icon-arrow-right"></i>
								Float Charts</a></li>
						<li><a class="waves-effect waves-dark"
				...
				<li class="treeview"><a class="waves-effect waves-dark"
					...
					<ul class="treeview-menu">
						<li class="treeview"><a href="#!"><i
							...
							<ul class="treeview-menu">
								<li><a class="waves-effect waves-dark"
									href="register1.html" target="_blank"><i
						...
						<li><a class="waves-effect waves-dark"
							href="sample-page.html"><i class="icon-arrow-right"></i>
								Sample Page</a></li>
			...
			<div class="card card_main header-users-main">
				<div class="card-content user-box">
					...
					<div class="main-friend-list">
						...
						<div class="media friendlist-box" data-id="7"
							data-status="offline" data-username="Michael Scofield"
						...
						<div class="media friendlist-box" data-id="5" data-status="online"
							...
							<a class="media-left" href="#!"> <img
								class="media-object img-circle"
								src="<%=request.getContextPath()%>/assets/images/avatar-4.png"
								alt="Generic placeholder image">
								<div class="live-status bg-success"></div>
							</a>
							<div class="media-body">
						...
						<div class="media friendlist-box" data-id="6"
							data-status="offline" data-username="Sara Tancredi"
							data-toggle="tooltip" data-placement="left" title="Sara Tancredi">
							<a class="media-left" href="#!"> <img
								class="media-object img-circle"
								src="<%=request.getContextPath()%>/assets/images/avatar-5.png"
								alt="Generic placeholder image">
								<div class="live-status bg-danger"></div>
							</a>
							<div class="media-body">
